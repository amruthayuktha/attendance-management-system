    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Amrutha/Downloads/attendance management/Attendance/Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Amrutha\Downloads\attendance management\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'amrutha':
            if password == 'amrutha123':
                ...
                cs = 'C:Users/Amrutha/Downloads/attendance management/StudentDetails/StudentDetails.csv'
